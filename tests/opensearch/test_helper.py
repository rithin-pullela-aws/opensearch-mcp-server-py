...
class TestOpenSearchHelper:
    ...
    def test_list_indices(self, mock_initialize_client):
        ...
        # Execute
        result = self.list_indices(ListIndicesArgs(opensearch_cluster_name=''))
    ...
    def test_get_shards(self, mock_initialize_client):
        ...
        # Execute
        result = self.get_shards(GetShardsArgs(index='test-index', opensearch_cluster_name=''))
    ...
    def test_list_indices_error(self, mock_initialize_client):
        ...
        with pytest.raises(Exception) as exc_info:
            self.list_indices(ListIndicesArgs(opensearch_cluster_name=''))
    ...
    def test_get_shards_error(self, mock_initialize_client):
        ...
        # Execute and assert
        with pytest.raises(Exception) as exc_info:
            self.get_shards(GetShardsArgs(index='non-existent-index', opensearch_cluster_name=''))
